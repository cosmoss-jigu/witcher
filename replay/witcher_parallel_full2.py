...
from engines.witcherparallelfull.witcherparallelfullengine2 import WitcherParallelFullEngine2
...
def main():
    ...
    witcher_parallel_full_engine = WitcherParallelFullEngine2(args)
