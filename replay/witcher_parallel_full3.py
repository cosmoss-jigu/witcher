...
from engines.witcherparallelfull.witcherparallelfullengine3 import WitcherParallelFullEngine3
...
def main():
    ...
    witcher_parallel_full_engine = WitcherParallelFullEngine3(args)
