...
class WitcherParallelPDG : public ModulePass {
public:
  static char ID;
  WitcherParallelPDG() : ModulePass(ID) {}
...
class WitcherParallelPPDG : public ModulePass {
public:
  static char ID;
  WitcherParallelPPDG() : ModulePass(ID) {}
  ...
  virtual void getAnalysisUsage(AnalysisUsage &AU) const {
    AU.addRequiredTransitive<QueryLoadStoreNumbers>();
    AU.addRequiredTransitive<WitcherParallelPDG>();
