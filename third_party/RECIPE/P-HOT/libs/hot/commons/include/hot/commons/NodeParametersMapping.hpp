...
// NEED TO CHECK  Added somethings to solve compile error***
template<> struct NodeParametersToNodeType<MultiMaskPartialKeyMapping<4u>, uint8_t> {
	static constexpr NodeType  mNodeType { NodeType ::MULTI_MASK_32_BYTES_AND_32_BIT_PARTIAL_KEYS };
};

template<> struct NodeParametersToNodeType<MultiMaskPartialKeyMapping<4u>, uint16_t> {
	static constexpr NodeType  mNodeType { NodeType ::MULTI_MASK_32_BYTES_AND_32_BIT_PARTIAL_KEYS };
};

template<> struct NodeParametersToNodeType<MultiMaskPartialKeyMapping<2u>, uint8_t> {
	static constexpr NodeType  mNodeType { NodeType ::MULTI_MASK_16_BYTES_AND_16_BIT_PARTIAL_KEYS };
};
template<> struct NodeParametersToNodeType<MultiMaskPartialKeyMapping<2u>, uint32_t> {
	static constexpr NodeType  mNodeType { NodeType ::MULTI_MASK_16_BYTES_AND_16_BIT_PARTIAL_KEYS };
};
