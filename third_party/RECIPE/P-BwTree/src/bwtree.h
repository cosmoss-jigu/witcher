  ...
  class ElasticNode : public BaseNode {
   ...
   public: 
    ...
    inline static ElasticNode *Get(int size,         // Number of elements
      ...
      nvm_aligned_alloc((void **)&alloc_base,64,sizeof(ElasticNode) + size * sizeof(ElementType) + AllocationMeta::CHUNK_SIZE);
      //char* alloc_base = (char *)nvm_alloc(sizeof(ElasticNode) + size * sizeof(ElementType) + AllocationMeta::CHUNK_SIZE);
/*      char *alloc_base = \
