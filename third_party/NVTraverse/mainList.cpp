...
int main(int argc, char **argv) {
    ...
    if (!ALG_NAME.compare("ListOriginal")) {
            run<ListOriginal<int>>(false);
    } else if (!ALG_NAME.compare("ListIz")) {
            run<ListIz<int>>(true);
    } else if (!ALG_NAME.compare("ListTraverse")) {
            run<ListTraverse<int>>(true);
    }
    else {
