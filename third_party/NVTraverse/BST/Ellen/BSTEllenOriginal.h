...
public:
    ...
    BSTEllenOriginal(const int _NUM_THREADS, const skey_t& _BST_KEY_MIN, const skey_t& _BST_KEY_MAX, const sval_t& _VALUE_RESERVED, unsigned int id/*, EpochThread epoch*/)
